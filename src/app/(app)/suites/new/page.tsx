...
export default function NewSuitePage() {
  ...
  return (
    <div className="mx-auto max-w-lg">
      <h1 className="font-display text-2xl font-medium text-signal-white">Create a suite</h1>
      <p className="mt-1 text-sm text-signal-muted">Add criteria once the suite is created.</p>
      <form onSubmit={onSubmit} className="mt-6 flex flex-col gap-4">
        <Field label="Suite name" type="text" value={name} onChange={setName} required />
